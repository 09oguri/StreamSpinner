...
public class PostgreSQLConnector implements DBConnector {
	...
	throws HarmonicaException{
		...
		String jdbc_url = "jdbc:postgresql://"+url+"/"+db+option;
		debug(jdbc_url);
		...
		try{
			...
			throw new HarmonicaException("can't connect PostgreSQL.");
		}
	}
	...
	public void disconnect() throws HarmonicaException{
		try{
			...
			debug("Disconnect to PostgreSQL!");
		}catch(Exception e){
	...
	private void debug(Object o){
		HarmonicaManager.debug("PostgreSQL",o);
	}
}
